        ...
        return <Fragment>
            ...
            <div class="card">
                ...
                <article class={`card-content article${'direction' in page ? ' ' + page.direction : ''}`} role="article">
                    ...
                    {/* Licensing block */}
                    {!index && article && article.licenses_show === true && Object.keys(article.licenses)
            ...
            {/* Post navigation */}
            {!index && (page.prev || page.next) && article.show_neighbor ? <nav class="post-navigation mt-4 level is-mobile">
